...
レッスン内での問題スキップと前後移動、キーボード操作(各ボタンにキー表示)も。
バックエンドなし — 進捗はブラウザの localStorage に保存。
...
- v6: 穴埋め(空欄補充)504 ✅ / TOPIK 模擬試験(TOPIK I 175・II 169 = 計 344 問、聞き取り・読解、自動採点)✅ /
  流し聞き(自動再生リスニング)✅
- v7: レッスン内ナビゲーション(問題スキップ・前後移動)+ 共通 UI の共有化リファクタ ✅
  — 全 11 デッキ・計 3,344 項目(1 レッスン 6 問固定)
- v8: 学習・流し聞きのキーボード操作(各ボタンにキー表示)+ UI ポリッシュ
  (終了ボタンのタップ領域・出題/流し聞きの上下バウンス除去・選択肢の縮小)✅
- v9+: 学習統計、コンテンツ拡張
